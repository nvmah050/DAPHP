<?php 
  ...
  $product = $db->fetchID("product",$id); // Truy vấn để lấy tên danh mục theo ID
            ...
            <section class="box-main1" >
                <div class="col-md-6 text-center">
                    ...
                    <ul class="text-center bor clearfix" id="imgdetail">
                        ...
                        <li>
                            <img src="<?php echo base_url() ?>public/frontend/images/tang-kem.jpg" class="img-responsive pull-left" width="80" height="80">
                        </li>
                ...
                <div class="col-md-6 bor" style="margin-top: 20px;padding: 30px;">
                   <ul id="right">
                        ...
                        <?php if($product['sale']>0): ?>
                        	<li><p><strike class="sale">Gia Ban : <?php echo formatprice($product['price']) ?></strike></br>
                         	<b class="price">Gia Khuyen Mai : <?php echo formatpricesale($product['price'],$product['sale']) ?></b</li>
                    	<?php slse : ?>
                    		<li><p><?php echo formatpricesale($product['price'],$product['sale']) ?></b</li>
                    	<?php endif; ?>
                ...
                <div class="row">
                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade in active">
                            <h3>Nội dung</h3>
                            <p></p><?php echo $product['content'] ?></p>
                        </div>
