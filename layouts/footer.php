 ...
 <div class="container">
                            ...
                            <div class="col-md-3" id="footer-support">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p><i class="fa fa-home" style="font-size: 16px;padding-right: 5px;"></i> 613 Đại Học Văn Hiến  </p>
                                        <p><i class="sp-ic fa fa-mobile" style="font-size: 22px;padding-right: 5px;"></i> 0923635200</p>
                                        <p><i class="sp-ic fa fa-envelope" style="font-size: 13px;padding-right: 5px;"></i> phuprokute123456789@gmail.com</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <section id="ft-bottom">
                    <p class="text-center">Copyright © 2019 . Design by  Sang !!! </p>
                </section>
            </div>
        </div>      
    </div>
